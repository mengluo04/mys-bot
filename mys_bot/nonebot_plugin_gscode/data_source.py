...
async def get_data(type: Literal["activity", "index", "srcode"], data: dict = {}) -> dict:
    """米哈游接口请求"""

    url = {
        "activity": "https://bbs-api.miyoushe.com/apihub/api/home/new?gids=2&parts=1%2C3%2C4&device=OnePlus%20IN2025&cpu=placeholder&version=3",
        "index": "https://api-takumi.mihoyo.com/event/miyolive/index",
        "srcode": "https://api-takumi-static.mihoyo.com/event/miyolive/refreshCode",
    }
...
async def get_code(version: str, act_id: str) -> Union[dict, list[dict]]:
    ...
    ret = await get_data("srcode", {"version": version, "actId": act_id})
    if ret.get("error") or ret.get("retcode") != 0:
